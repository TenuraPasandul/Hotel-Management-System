    ...
    <div className='home'>
      ...
      <div className='home-para1'>
        ...
        <div className='home-gallery'>
          <div className='gallery-item'><img src={image1} className='gallery-left row1' /></div>
          <div className='gallery-item middle'><img src={image2} className='gallery-middle row1' /></div>
          <div className='gallery-item'><img src={image3} className='gallery-right row1' /></div>
          <div className='gallery-item'><img src={image4} className='gallery-left row2' /></div>
          <div className='gallery-item' style={{marginLeft:'37%'}}><img src={image5} className='gallery-right row2' /></div>
        </div>
